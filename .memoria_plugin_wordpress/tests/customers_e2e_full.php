...
// Bootstrapea el WP del entorno la-instalacion-de-pruebas por defecto. Override con env
// TPV_SYNC_WP_ROOT si el test corre contra otra instalación.
$wpRoot = getenv('TPV_SYNC_WP_ROOT') ?: '/ruta/a/tu/wordpress';
...
global $wpdb;
$pdo = new PDO('mysql:host=localhost;dbname=tu_bd', 'root', '***REMOVED***');
