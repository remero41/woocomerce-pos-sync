#!/usr/bin/env bash
# =============================================================================
# Caza bugs WP: 200 tests e2e sobre el plugin woocommerce_conector (tpv85)
# =============================================================================
# Cada test imprime "✔" (PASS) o "✖" (FAIL) con el motivo. Resumen por área final.
# Requisitos: WP85 (tpv85.catinfog.com) + TPV API (tpv7.catinfog.com) accesibles.
# Plantilla basada en cazabugs_100.sh de PrestaShop (tpv100).
set -u

BASE="https://tpv85.catinfog.com/wp-content/plugins/woocommerce_conector/tests/e2e_api.php"
SECRET="9ac41a8357d5260fe02a8ef6cdf986e96ab516c3d0bb2cde000a94a87cbd1d65"
WEBHOOK_URL="https://tpv85.catinfog.com/tpv-webhook/"
...
define("ABSPATH","/var/www/html/tpv85/public_html/");
$_SERVER["HTTP_HOST"]="tpv85.catinfog.com";
...
R=$(call "action=check_config")
assert_eq "A01" "api_url presente" "https://tpv7.catinfog.com/api/v1" "$(jq_f "$R" '.api_url')"
