...
(plugin PrestaShop) para el plugin WooCommerce `woocommerce_conector` en tpv85.
...
- WP85 activo en `https://tpv85.catinfog.com` (DB `tpv85` root/paquito)
...
- TPV API accesible en `https://tpv7.catinfog.com/api/v1`
